...
//put your code here
    ...
    protected  function saveRecord($obj,$table,$updated_db_pair=array()) {
        $return=0;
        ...
        if(((array_key_exists('id',$obj) && !empty($obj->id))) && $obj->id != '') {
    ...
    //array_walk_recursive($fields, 'arrayfilterString');
        if(array_key_exists('name',$fields)) {
            if($is_update) {
				...
				if(array_key_exists('blocks_id',$fields)) {
					 $duplicate_check_fields.=" and blocks_id='".$fields->blocks_id."' ";
				}
            }
